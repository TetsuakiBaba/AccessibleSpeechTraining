...
(function (root, factory) {
    ...
    p5.Speech = function (_dv, _callback) {
        ...
        window.speechSynthesis.onvoiceschanged = function () {
            if (that.isLoaded == 0) { // run only once
                ...
                that.utterance.onsoundstart = function (e) {
                    if (that.onSoundStart != undefined) that.onSoundStart(e);
                };
                that.utterance.onsoundend = function (e) {
                    if (that.onSoundEnd != undefined) that.onSoundEnd(e);
                };
            }
        };
    ...
    p5.Speech.prototype.soundstarted = function (_cb) {
        this.onSoundStart = _cb;
    }

    p5.Speech.prototype.soundended = function (_cb) {
        this.onSoundEnd = _cb;
    }
    ...
    p5.SpeechRec = function (_lang, _callback) {
        ...
        this.onSoundStart; // ...and ends (in non-continuous mode).
        this.onSoundEnd; // ...and ends (in non-continuous mode).
        ...
        this.rec.onsoundstart = function (e) {
            if (that.onSoundStart != undefined) that.onSoundStart(e);
        };
        this.rec.onsoundend = function (e) {
            if (that.onSoundEnd != undefined) that.onSoundEnd(e);
        };
